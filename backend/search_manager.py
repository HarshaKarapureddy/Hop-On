...
def SearchGS(game_name):
    ...
    query = f'search "{game_name}"; fields id, name, genres.name, release_dates.y, cover.url, themes; limit 50; where themes != (42);'
...
def SearchGEN(genres_list):
    ...
    try:
        ...
        return None
def search_game_by_name(game_name): # use this one in search.jsx
    if not game_name:
